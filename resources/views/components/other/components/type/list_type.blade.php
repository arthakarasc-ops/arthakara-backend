...
<div class="container mx-auto px-6 py-10">
        <div class="w-full flex justify-between items-center mb-5">
            <h1 class="text-4xl font-bold text-gray-800">My Types</h1>
            <a href="{{ route('create-type') }}" class="bg-green-600 hover:bg-green-700 transition duration-300 rounded-md px-6 py-2 text-white font-semibold flex items-center">
        ...
        @forelse($types as $type)
            <div id="color" class="w-full flex justify-between border-2 border-blue-500 p-2 rounded-lg bg-blue-200 mb-7">
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('type.edit.form', ['typeId' => $type->id]) }}" class="bg-yellow-500 hover:bg-yellow-600 transition duration-300 rounded-md px-7 py-1 text-white font-semibold">Edit</a>
